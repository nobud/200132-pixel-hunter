...
import {getTestAnswers} from '../../data/test-data';
...
describe(`calc scores for game`, () => {
  it(`should return -1 when the count of answers < 10`, () => {
    ...
    expected = -1;
    assert.equal(new Result(getTestAnswers(TypeAnswer.NORMAL, lengthAnswers)).score, expected);
  });
